...
export default class BarChart extends Component {
    ...
    drawChart() {
        ...
        const bar_width = 4;
        const spacing = 1;
        const w = data.length * (bar_width + spacing) + 2*padding;
        ...
        const svg = d3.select("body")
                        .append("svg")
                        .attr("id", "sunspots-chart")
                        .attr("width", w)
                        .attr("height", h);
        svg.selectAll("rect").data(data).enter().append("rect")
        .attr("x", (d, i) => i * (bar_width + spacing) + padding)
        .attr("y", (d, i) => h - yDataScale(d[1]) - padding)
        .attr("width", bar_width)
        .attr("height", (d) => yDataScale(d[1]))
        .attr("fill", "carmine")
        .attr("class", "bar")
        .append("title")
        .text(d => d[1])
